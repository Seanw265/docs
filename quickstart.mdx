...
<Frame caption="Easel's 'New Project' screen. Your existing projects appear in the sidebar.">
  <img src="/images/quickstart/overview-example-1.png" alt="New project screen (light mode)" className="block dark:hidden rounded-lg border" />
  <img src="/images/quickstart/overview-example-1-dark.png" alt="New project screen (dark mode)" className="hidden dark:block rounded-lg border border-gray-500/50" />
</Frame>
...
<Frame caption="Easel's chat interface: messages on the left, your app on the right.">
  <img src="/images/quickstart/chat-example-1.png" alt="Chat interface (light mode)" className="block dark:hidden rounded-lg border" />
  <img src="/images/quickstart/chat-example-1-dark.png" alt="Chat interface (dark mode)" className="hidden dark:block rounded-lg border border-gray-500/50" />
</Frame>

...
Easel is a powerful system for building entire web apps and websites using natural language. It empowers anyone to create interactive experiences, with or without knowledge of code.
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="pen-to-square" href="/quickstart">
    All you need to build your first app with Easel
  </Card>
